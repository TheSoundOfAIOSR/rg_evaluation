...
def test_environ_setting():
    ...
    assert Config.is_defined_in_environ(var_names=dummy_var_names)
...
def test_environment_config():
    ...
    config = Config.load_config(var_names=dummy_var_names, config_file=dummy_config)
...
def test_config_not_found():
    ...
    with pytest.raises(FileNotFoundError):
        Config.load_config(var_names=dummy_var_names, config_file=bad_config_path)
